...
<head>
    ...
    <meta name="description" content="Casa dos Bispos Software - Dashboard">
    <meta name="author" content="André Lourenço">
    <title>Casa dos Bispos Software - Dashboard</title>
    <!-- Favicon -->
...
<body>
                    ...
                    <div class="card bg-gradient-secondary shadow">
                        <div class="card-header bg-transparent">
                            <div class="row align-items-center">
                                <div class="col">
                                    <h6 class="text-uppercase text-light ls-1 mb-1">Contactos através do site</h6>
                                    <h2 class="text-white mb-0">Nº de Contactos por mês através do site</h2>
                                </div>
                                <div class="col">
                ...
                <div class="col-xl-12 mb-5 mb-xl-0">
                    <div class="card shadow">
                        <div class="card-header border-0">
                            <div class="row align-items-center">
                                <div class="col">
                                    <h3 class="mb-0 text-primary">Nº de Contactos através do site</h3>
                                </div>
                            </div>
                        </div>
    ...
    <script>
            ...
            $.ajax({
                ...
                success: function (res) {
                    ...
                    for (var i = 0; i < dados.length; i++) {
                        var contactosPorMes = dados[i].split('@');
                        meses[i] = contactosPorMes[1];
                        nr_contactos[i] = contactosPorMes[0];
                    }

                    var $chart = $('#dashboard-graphic');
                    if ($chart.length) {
                        initChartVendas($chart, meses, nr_contactos);
                    }
                }
            });
        }
        ...
        function getContactosSite() {
            $.ajax({
                type: "POST",
                url: "dashboard.aspx/getContactosSite",
                //data: '{"idCliente":"' + id + '"}',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (res) {
