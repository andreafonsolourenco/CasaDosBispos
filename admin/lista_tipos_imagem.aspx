<%@ Page Language="C#" AutoEventWireup="true" CodeFile="lista_tipos_imagem.aspx.cs" Inherits="lista_tipos_imagem" %>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
    <meta name="description" content="Casa dos Bispos Software - Tipos de Imagem">
    <meta name="author" content="André Lourenço">
    <title>Casa dos Bispos Software - Tipos de Imagem</title>
    <!-- Favicon -->
...
<body>
    ...
    <div class="main-content">
        ...
        <nav class="navbar navbar-top navbar-expand-md navbar-dark" id="navbar-main">
            <div class="container-fluid">
                <!-- Brand -->
                <a class="h4 mb-0 text-white text-uppercase d-none d-lg-inline-block">Tipos de Imagens</a>
                <!-- Form -->
                                ...
                                <tr>
                                    <td style="width: 50%; max-width: 50% !important;">
                                        <div style="float:left">
                                            <h3 class="mb-0">Tipos de Imagens</h3>
                                        </div>
                                    </td>
                                    ...
                                    <td style="width: 15%; max-width: 15% !important; text-align: right;">
                                        <div id="divCriaNovo">
                                            <a class="btn btn-sm btn-primary" onclick="novo();" style="color: #FFFFFF;">
                                                <span id="spanBtnAlteraStatus"><i class="ni ni-collection" aria-hidden="true"></i>  Criar novo tipo de imagem</span>
                                            </a>
                                        </div>
                                    </td>
                                </tr>
                                ...
                                <table style="width:100%; height: auto;">
                                    <tr>
                                        <td style="width: 25%; max-width: 25% !important; text-align: left;">
                                            <div>
                                                <button type='button' style="width:100%; height: 100%;" class='btn btn-sm btn-primary' id='buttonFileUpload' onclick='simulateClickOnFileUploadButton();' runat='server'>Carregar Ficheiro Tipos de Imagens</button>
                                            </div>                                        
                                        </td>
                                        ...
                                        <td style="width: 25%; max-width: 25% !important; text-align: center;">
                                            <div>
                                                <asp:Button runat="server" Text="Carregar Tipos de Imagens para o Sistema" ID="uploadButton" OnClick="Upload_Click" CssClass="btn btn-sm btn-primary" />
                                            </div>                                        
                                        </td>
    ...
    <script>
        ...
        function getData() {
            loadingOn('A carregar os tipos de imagens. Por favor aguarde...');
            var pesquisa = $('#txtPesquisa').val();
            var order = "";

            if (ordNome == 0 && ordOrdem == 0) {
                order = ' ORDER BY ordem asc, nome asc ';
            }
            else {
                order = ' ORDER BY ';
            ...
            $.ajax({
                type: "POST",
                url: "lista_tipos_imagem.aspx/getGrelha",
        ...
        function editar(id) {
            loadUrl('config_ficha_tipos_imagem.aspx?id=' + id);
        }

        function eliminar(id) {
            swal({
                title: 'Eliminar tipo de imagem',
                text: "O tipo de imagem será eliminado. Confirma?",
                type: 'question',
        ...
        function delRow(id) {
            $.ajax({
                type: "POST",
                url: "lista_tipos_imagem.aspx/delRow",
                ...
                success: function (res) {
                    ...
                    if (parseInt(res) <= 0) {
                        sweetAlertWarning("Eliminar tipo de imagem", resMsg);
                    }
                    else {
                        $('#txtPesquisa').val('');
                        ordNome = 0;
        ...
        function novo() {
            loadUrl('config_ficha_tipos_imagem.aspx');
        }
