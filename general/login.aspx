...
<head>
    ...
    <meta name="description" content="Casa dos Bispos Software - Login">
    <meta name="author" content="André Lourenço">
    <title>Casa dos Bispos Software - Login</title>
    <!-- Favicon -->
    ...
    <style>
        .bg-gradient-primary {
            background: linear-gradient(87deg, #7D0C0E 0, #C80C0E 100%) !important;
        }
...
<body class="bg-default" style="background-color: #7D0C0E !important">
                ...
                <div class="header-body text-center mb-7">
                    <div class="row justify-content-center">
                        <div class="col-lg-12 col-md-12">
                            ...
                            <p class="text-lead text-white">Bem-vindo à area de administração da Casa dos Bispos!</p>
                        </div>
                    </div>
                </div>
            </div>
